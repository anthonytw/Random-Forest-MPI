...
unit_tests/%.o: ../unit_tests/%.cpp
	...
	g++ -I"/media/sf_Protected/Documents/Workspace/RF/inc" -I"/media/sf_Protected/Documents/Workspace/RF/unit_tests" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
